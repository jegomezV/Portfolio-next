...
export default function AboutWorks() {
  ...
  return (
    <section id="about" className="about-section" data-scroll-section>
      <div className="font-white ml-1 tablet-m-0 title title-description"  data-scroll data-scroll-direction="vertical" data-scroll-speed="2">Hi, I'm Juan, a passionate software developer in Colombia. I like to learn new things every day and challenge myself with new works.</div>
